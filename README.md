...
I’m currently learning about data structures and algorithms : *https://algorithm.show*. Please join our [`CTFlag Org`](https://github.com/CTFlag) if you interested in `CTF` or wanna to be a hacker : *https://ctflag.org* and welcome you join our [`Golang Family`](https://github.com/google-golang) : *https://golanger.org* or [`RaspberryPI Family`](https://github.com/raspberry-pi-org) : *https://raspi.website*. Study notes about everything what I want to learn in the daily life : *https://studynote.life*
